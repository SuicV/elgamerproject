...
@section('content')
    <section role="banner"style="background :url('/imgs/nvidia-1201077_1280.jpg') no-repeat center center fixed; background-size:cover;" class="jumbotron jumbotron-fluid d-flex">
