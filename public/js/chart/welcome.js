  ...
  $(".controleProduct").on("click", function () {
    ...
    if (parseInt(input.val()) >= 1) {
      $.ajax({
        ...
        data: {
          "quantity": input.val(),
          "product_id": el.parent().find("input[name='p']").val()
        }
      }).done(function (data) {
        console.log(data);
...
/***/ 2:
/*!*********************************************!*\
  !*** multi ./resources/js/chart/welcome.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/suicv/Sites/ecommerceporject/resources/js/chart/welcome.js */"./resources/js/chart/welcome.js");
